...
#     autolabel(rects2)
    ...
    plt.savefig("plots/" + st + "-" + filename + ".png")
    plt.show()
...
print "HERE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n\n\n\n"
plotPowerandCPU(vheights, heightssummary, targets=heights, xlabel='Video height (Youtube)', title="Mean Bitrate for Youtube Videos", filename="/Users/oche/Dropbox/Documents/Papers/ism2015/figures/mean_bw_youtube.eps")
